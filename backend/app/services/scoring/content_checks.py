...
def check_specificity(resume: Any) -> CheckResult:
    ...
    if avg_score >= 2.5:
        return CheckResult(
            ...
            possible,
            evidence_data={
                "avg_specificity": round(avg_score, 2),
                "high_specificity_bullets": high_specificity,
            },
        )
    elif avg_score >= 1.5:
        return CheckResult(
