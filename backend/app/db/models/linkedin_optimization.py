...
class LinkedInOptimization(Base):
    ...
    original_profile: Mapped[dict] = mapped_column(
        JSONBType, default=dict, nullable=False
    )  # headline, about, experience, skills, projects, featured
    optimized_profile: Mapped[dict] = mapped_column(
        JSONBType, default=dict, nullable=False
    ...
    recommendations: Mapped[dict] = mapped_column(
        JSONBType, default=dict, nullable=False
    )  # array of checklist suggestions
